...
<head>
    ...
    <title>Edit Program - Admin SMK Negeri 11 Bandung</title>
        ...
        <div class="col-md-10">
            <nav class="navbar-admin">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 fw-bold" style="color: var(--primary-blue);"><i class="fas fa-edit me-2"></i>Edit Program Keahlian</h4>
                ...
                <div class="form-card">
                    <form method="POST" action="{{ route('admin.program.update', $program->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                       name="nama" value="{{ old('nama', $program->nama) }}" required 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       name="slug" value="{{ old('slug', $program->slug) }}" required 
                                       placeholder="rekayasa-perangkat-lunak" id="inputSlug">
                                @error('slug')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                <small class="form-text"><i class="fas fa-info-circle me-1"></i>Auto-generate dari nama, bisa diedit manual</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('singkatan') is-invalid @enderror"
                                       name="singkatan" value="{{ old('singkatan', $program->singkatan) }}" required 
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                          name="deskripsi" rows="3" placeholder="Jelaskan program keahlian ini...">{{ old('deskripsi', $program->deskripsi) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('visi') is-invalid @enderror"
                                          name="visi" rows="2" placeholder="Visi program...">{{ old('visi', $program->visi) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('misi') is-invalid @enderror"
                                          name="misi" rows="3" placeholder="Misi program...">{{ old('misi', $program->misi) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="current-logo">
                                    <small class="form-text d-block mb-1">Logo saat ini:</small>
                                ...
                                <small class="form-text">Kosongkan jika tidak ingin mengubah. Max 2MB</small>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('urutan') is-invalid @enderror"
                                       name="urutan" value="{{ old('urutan', $program->urutan) }}" min="0">
                        ...
                        <div class="d-flex gap-3 mt-4 pt-3 border-top">
                            ...
                            <button type="button" class="btn-danger-custom" id="deleteBtn" data-id="{{ $program->id }}">
...
document.getElementById('deleteBtn')?.addEventListener('click', function() {
    if(confirm('Yakin ingin menghapus program ini?')) {
        ...
        form.action = `/admin/program/${this.dataset.id}`;
        form.submit();
    }
});
