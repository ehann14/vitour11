                    ...
                    <div class="form-card">
                        <form action="{{ route('admin.program.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="singkatan" class="form-control" value="{{ old('singkatan') }}" required placeholder="Contoh: RPL" maxlength="10">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                                <textarea name="deskripsi" class="form-control" rows="3" placeholder="Jelaskan program keahlian ini...">{{ old('deskripsi') }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Visi</label>
                                <textarea name="visi" class="form-control" rows="2" placeholder="Visi program...">{{ old('visi') }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Misi</label>
                                <textarea name="misi" class="form-control" rows="3" placeholder="Misi program...">{{ old('misi') }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex gap-2 pt-3 border-top">
                                <button type="submit" class="btn-primary-custom"><i class="fas fa-save me-1"></i>Simpan Program</button>
