    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="p-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <form action="{{ route('admin.program.toggle-status', $item) }}" method="POST" class="d-inline">
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.program.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus program ini?')">
                                                @csrf @method('DELETE')
                                ...
                                <tr><td colspan="5" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <a href="{{ route('admin.program.create') }}" class="btn btn-primary btn-sm mt-3">Tambah Pertama</a>
                                    </div>
                                </td></tr>
                                @endforelse
                            </tbody>
                ...
                <div class="d-flex justify-content-center mt-4">{{ $programs->onEachSide(1)->links('pagination::bootstrap-5') }}</div>
                @endif
            </div>
        </div>
    </div>
