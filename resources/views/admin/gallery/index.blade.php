                                    ...
                                    @forelse($galleries as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($item->description)
                                                    <small class="text-muted">{{ \Illuminate\Support\Str::limit($item->description, 40) }}</small>
                                                @endif
                                            </td>
                                            <td>
                                                @if($item->category)
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <a href="{{ route('admin.gallery.edit', $item) }}" class="btn-action btn-edit" title="Edit">
