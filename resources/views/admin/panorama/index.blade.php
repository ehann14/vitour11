...
<head>
    ...
    <style>
        ...
        .preview-thumb { width: 80px; height: 50px; object-fit: cover; border-radius: 8px; border: 1px solid #dee2e6; background: #f8f9fa; }
        ...
        <div class="col-md-10">
            <nav class="navbar-admin">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.panorama.create') }}" class="btn-primary-custom"><i class="fas fa-plus"></i>Tambah Baru</a>
                </div>
            </nav>
            <div class="p-4">
                @if(session('success'))
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @if($item->image_path)
                                        <img src="{{ asset($item->image_path) }}" alt="{{ $item->name }}" class="preview-thumb">
                                        @else
                                        <div class="preview-thumb d-flex align-items-center justify-content-center bg-light"><i class="fas fa-image text-muted"></i></div>
                                        @endif
                                    </td>
                                    <td>
                ...
                <div class="d-flex justify-content-center mt-4">{{ $panoramas->onEachSide(1)->links('pagination::bootstrap-5') }}</div>
                @endif
            </div>
        </div>
    </div>
