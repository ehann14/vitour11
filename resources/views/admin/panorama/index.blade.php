...
<head>
    ...
    <style>
        ...
        .stat-card { background: white; border-radius: 16px; padding: 1.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.06); display: flex; align-items: center; gap: 1rem; }
        ...
        .table-card .table th { background: #f8f9fa; font-weight: 600; color: #495057; padding: 1rem; font-size: 0.9rem; }
        .table-card .table td { vertical-align: middle; padding: 1rem; font-size: 0.9rem; }
        .thumbnail-preview { width: 100px; height: 70px; object-fit: cover; border-radius: 8px; border: 2px solid #dee2e6; }
        .thumbnail-placeholder { width: 100px; height: 70px; background: #e9ecef; border-radius: 8px; display: flex; align-items: center; justify-content: center; border: 2px solid #dee2e6; }
        .thumbnail-placeholder i { font-size: 2rem; color: #6c757d; }
        .btn-action { padding: 0.4rem 0.8rem; border-radius: 6px; font-size: 0.85rem; margin: 0 2px; border: none; cursor: pointer; }
        .btn-edit { background: #17a2b8; color: white; }
        .btn-edit:hover { background: #138496; color: white; }
        .btn-delete { background: #dc3545; color: white; }
        .btn-delete:hover { background: #bd2130; color: white; }
        .btn-toggle { padding: 0.4rem 0.8rem; border-radius: 20px; font-size: 0.8rem; border: none; cursor: pointer; transition: all 0.2s; }
        .btn-toggle.active { background: #28a745; color: white; }
        .btn-toggle:not(.active) { background: #6c757d; color: white; }
        .badge-360 { background: rgba(0,201,177,0.15); color: var(--accent-teal); padding: 0.4rem 0.8rem; border-radius: 20px; font-size: 0.8rem; font-weight: 600; }
        .badge-normal { background: rgba(30,60,114,0.15); color: var(--primary-blue); padding: 0.4rem 0.8rem; border-radius: 20px; font-size: 0.8rem; font-weight: 600; }
        ...
        .filter-bar { background: white; border-radius: 16px; padding: 1.25rem 1.5rem; margin-bottom: 1.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
        .btn-primary-custom { background: var(--primary-blue); color: white; border-radius: 25px; padding: 0.6rem 1.5rem; border: none; display: inline-flex; align-items: center; gap: 0.5rem; text-decoration: none; transition: all 0.2s; }
        .btn-primary-custom:hover { background: var(--secondary-blue); color: white; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(30,60,114,0.3); }
        .scene-id-badge { background: #6c757d; color: white; padding: 0.3rem 0.6rem; border-radius: 6px; font-size: 0.8rem; font-family: monospace; display: inline-block; max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        .badge-status-aktif { background: #28a745; color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.75rem; }
        .badge-status-nonaktif { background: #6c757d; color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.75rem; }
    </style>
</head>
<body>
            ...
            <div class="col-md-2 sidebar p-0">
                ...
                <nav class="mt-3 p-2">
                    ...
                    <a href="{{ route('admin.program.index') }}" class="{{ request()->routeIs('admin.program.*') ? 'active' : '' }}">
                        <i class="fas fa-layer-group"></i><span>Kelola Program</span>
                    </a>
                    <a href="{{ route('admin.konsentrasi.index') }}" class="{{ request()->routeIs('admin.konsentrasi.*') ? 'active' : '' }}">
                        <i class="fas fa-sitemap"></i><span>Kelola Konsentrasi</span>
                    </a>
