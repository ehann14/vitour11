        ...
        <div class="col-md-10">
            <nav class="navbar-admin">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 fw-bold" style="color: var(--primary-blue);"><i class="fas fa-trophy me-2"></i>Kelola Prestasi</h4>
                    <a href="{{ route('admin.achievements.create') }}" class="btn-primary-custom"><i class="fas fa-plus"></i>Tambah Baru</a>
                </div>
            </nav>
            <div class="p-4">
                @if(session('success'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('admin.achievements.edit', $item) }}" class="btn-action btn-edit" title="Edit"><i class="fas fa-edit"></i></a>
                ...
                <div class="d-flex justify-content-center mt-4">{{ $achievements->onEachSide(1)->links('pagination::bootstrap-5') }}</div>
                @endif
            </div>
        </div>
    </div>
