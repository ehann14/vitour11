        ...
        <div class="col-md-10">
            <nav class="navbar-admin">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 fw-bold" style="color: var(--primary-blue);"><i class="fas fa-plus-circle me-2"></i>Tambah Prestasi Baru</h4>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('ranking') is-invalid @enderror"
                                       name="ranking" value="{{ old('ranking') }}" min="1" max="10" placeholder="1 = Juara 1">
                                @error('ranking')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Lokasi (Opsional)</label>
                                <input type="text" class="form-control @error('location') is-invalid @enderror"
                                       name="location" value="{{ old('location') }}" placeholder="Contoh: Bandung, Jawa Barat">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          name="description" rows="3" placeholder="Ceritakan singkat tentang pencapaian ini...">{{ old('description') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('student_name') is-invalid @enderror"
                                       name="student_name" value="{{ old('student_name') }}" required placeholder="Nama lengkap siswa">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('student_class') is-invalid @enderror"
                                       name="student_class" value="{{ old('student_class') }}" placeholder="Contoh: XII RPL 1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('advisor_title') is-invalid @enderror"
                                       name="advisor_title" value="{{ old('advisor_title') }}" placeholder="Contoh: Guru Pembina">
                            ...
                            <div class="col-12">
                                ...
                                <small class="form-text">Format: JPG, PNG, GIF, WebP. Maksimal 2MB.</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('order') is-invalid @enderror"
                                       name="order" value="{{ old('order', 0) }}" min="0" placeholder="0 = paling atas">
