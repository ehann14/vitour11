...
<head>
    ...
    <title>Tambah Prestasi - Admin SMK Negeri 11 Bandung</title>
            ...
            <div class="col-md-10">
                ...
                <nav class="navbar-admin">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 fw-bold" style="color: var(--primary-blue);">✨ Tambah Prestasi Baru</h4>
                        ...
                        <form action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="ranking" class="form-control" value="{{ old('ranking') }}" min="1" max="10" placeholder="1 = Juara 1">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Lokasi (Opsional)</label>
                                    <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Contoh: Bandung, Jawa Barat">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control" rows="3" placeholder="Ceritakan singkat tentang pencapaian ini...">{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="student_name" class="form-control" value="{{ old('student_name') }}" required placeholder="Nama lengkap siswa">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Kelas (Opsional)</label>
                                    <input type="text" name="student_class" class="form-control" value="{{ old('student_class') }}" placeholder="Contoh: XII RPL 1">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="advisor_title" class="form-control" value="{{ old('advisor_title') }}" placeholder="Contoh: Guru Pembina">
                                </div>
                            </div>
