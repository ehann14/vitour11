    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero {
            ...
            padding: 60px 0; position: relative; z-index: 3;
        }
        .hero-grid {
        ...
        .hero-badge {
            display: inline-flex; align-items: center; gap: 6px;
            background: rgba(0, 201, 177, 0.2); color: var(--accent-teal);
            padding: 6px 16px; border-radius: 40px;
            font-weight: 600; margin-bottom: 20px;
            border: 2px solid var(--accent-teal); font-size: 0.9rem;
        }
        .hero h1 {
            font-size: 2.8rem; font-weight: 800; line-height: 1.2;
            margin-bottom: 20px; text-shadow: 0 4px 15px rgba(0,0,0,0.3);
        }
        .hero h1 span {
            color: var(--accent-teal); display: block;
            margin-top: 8px; font-size: 2.6rem;
        }
        .hero-subtitle {
            font-size: 1.2rem; margin-bottom: 30px;
            opacity: 0.95; font-weight: 300; line-height: 1.6;
        }
        ...
        .hero-images {
            ...
            grid-template-rows: repeat(2, 1fr); gap: 12px; position: relative;
        }
        .hero-img {
            border-radius: 25px; overflow: hidden;
            box-shadow: 0 8px 25px rgba(0,0,0,0.3);
            transition: all 0.4s ease; height: 220px; position: relative;
        }
        .hero-img img {
        ...
        /* School Stats */
        .school-stats {
            display: grid; grid-template-columns: repeat(2, 1fr); gap: 18px; margin-bottom: 30px;
        }
        .stat-card {
            background: linear-gradient(135deg, var(--primary-blue), var(--secondary-blue));
            color: var(--white); padding: 20px; border-radius: 30px;
        ...
        .vision-card, .mission-card {
            background: var(--white); border: 2px solid var(--primary-blue);
        ...
        .mission-list {
            list-style: none; display: flex; flex-direction: column; gap: 12px; padding-left: 10px;
        }
        .mission-list li {
            display: flex; align-items: flex-start; gap: 12px;
            font-size: 0.95rem; line-height: 1.6; color: var(--gray-700); padding: 5px 0;
        }
        .mission-list li i {
            color: var(--accent-teal); font-size: 1.1rem; margin-top: 4px; flex-shrink: 0;
        }
        ...
        .school-info-card {
            ...
            border: 2px solid var(--gray-300); transition: all 0.3s ease;
        }
        ...
        .info-item {
            ...
            padding: 10px 0; border-bottom: 1px solid var(--gray-300);
        }
        .info-item:last-child { border-bottom: none; padding-bottom: 0; }
        .info-label {
            font-weight: 600; color: var(--gray-600);
            font-size: 0.9rem; min-width: 110px;
        }
        .info-value {
            font-weight: 600; color: var(--primary-blue);
            font-size: 1rem; text-align: right; max-width: 65%;
        }
        .info-badge {
        ...
        .address-item i {
            ...
            min-width: 28px; display: flex; align-items: center;
        }
        .address-label {
        ...
        .address-text {
            margin: 0; color: var(--primary-blue);
            font-weight: 500; font-size: 1rem; line-height: 1.5;
        }
        
        /* Map Card */
        .map-card {
            background: var(--white); border-radius: 30px; padding: 28px;
            box-shadow: 0 4px 15px rgba(0,0,0,0.1);
            border: 2px solid var(--gray-300); transition: all 0.3s ease;
        }
        .map-card:hover {
        ...
        .map-container {
            height: 300px; border-radius: 25px; overflow: hidden;
            box-shadow: 0 6px 20px rgba(0,0,0,0.15);
        }
        ...
        .gallery-item {
            ...
            height: 280px; transition: all 0.4s ease;
        }
        .gallery-item img {
            width: 100%; height: 100%; object-fit: cover;
            transition: transform 0.5s ease;
        ...
        .gallery-overlay {
            ...
            padding: 25px 20px; color: var(--white);
        ...
        @media (max-width: 768px) {
            ...
            .school-info-card, .address-card, .map-card,
            .vision-card, .mission-card { border-radius: 25px; padding: 22px; }
            .info-grid { gap: 12px; }
            ...
            /* Hide login button text on small mobile, show icon only */
            ...
            <div class="profile-container">
                ...
                <div class="school-stats">
                    <div class="stat-card">
                        ...
                        <div class="stat-info"><h3>1980</h3><p>Tahun Berdiri</p></div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon"><i class="fas fa-award"></i></div>
                        <div class="stat-info"><h3>A</h3><p>Akreditasi Unggul</p></div>
                    </div>
                    <div class="stat-card">
